...
<body>
	...
	목적 : JSTL JSP 페이지에서 반복, 조건문, 데이터 포멧팅, 데이터베이스 접근 과 같은 작업을 수행할 때 사용
	...
	HttpServletRequest 객체에 저장해서 JSP 페이지 내에서 그 데이터를 다른페이지로 전달하거나
	그 페이지 내에서 사용할 수 있도록 설정
	문법 예졔 : request.setAttribute(String name, 자료형 value)
	...
	// userage 변수명 안에 20 이라는 숫자를 저장하고 다른데에서 숫자를 ㅏㅅ용
	%>
	...
	// dispatcher : 전달자 상태를 전달한다는 의미 보내다 운항관리자 배차원 : dispatcher
